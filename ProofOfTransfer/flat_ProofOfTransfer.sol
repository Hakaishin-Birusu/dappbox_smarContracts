...
{ 
   ...
   */
    mapping (string => FileProof[]) fileProofs; // this allows to look up proof of transfer by the hashfile
    ...
    mapping(string => bool)  usedFileHashes;
    ...
    function _inCreateFileTransferProof(address _sender, address _receiver, string memory _fileHash,uint256 time, bytes32 QRWithNoTime ,bytes32 QRWithTime) internal returns (bool)
    {
     ...
     */
    function _inCreateFolderTransferProof(address _sender,address _receiver,address _folderAddress,string memory _folderHash,uint256 time,bytes32 QRWithNoTime,bytes32 QRWithTime) internal returns(bool)
    {
     ...
     */
    function _inGetFileTransferProofs(string memory fileHash, uint256 index) internal view returns (address[] memory, bytes32, bool)
    {   
   ...
   */
     ...
     */
    function _inGetFileTransferProofsDateTime(string memory fileHash,uint256 index ,uint256 len) internal view returns (address[] memory, bytes32, uint256[] memory,bool)
    {     
    ...
    function _inGetFolderTransferProofs(address folderAddress,uint256 index) internal view returns(address[] memory,string memory , bytes32, bool)
    {   
        address[] memory senderAndReceiver = new address[](2);
        ...
        string memory folderHash = folderProofs[folderAddress][index].folderHash;
     ...
     */
    function _inGetFolderTransferProofsWithDateTime(address folderAddress,uint256 index, uint256 len) internal view returns (address[] memory,string memory,bytes32, uint256[] memory,bool)
    {   
     ...
     */
    function _InSearchFileTransferProof(bytes32 QRCode) internal view returns(address , address , string memory)
      {
        string memory Hash;
     ...
     */
    function _InSearchFileTransferProofWithTime(bytes32 QRCode) internal view returns(address , address , uint256 , uint256 , uint256 ,string memory)
    {
        string memory Hash;
     ...
     */
    function _InSearchFolderTransferProof(bytes32 QRCode) internal view returns(address , address , address , string memory)
    {
        address folderAddress;
     ...
     */
    function _InSearchFolderTransferProofWithTime(bytes32 QRCode) internal view returns(address ,address , address , string memory,uint256 , uint256 , uint256)
    {
        address folderAddress;
     ...
     */
    function fileExists(string memory fileHash)internal view  returns (bool)
    {
        bool exists = false;
...
// File: contracts/ProofOfTransfer.sol
...
{ 
   ...
   */
    function createFileTransferProof(address _sender, address _receiver, string memory _fileHash) public returns (bool)
    {
   ...
   */
    function createFolderTransferProof(address _sender, address _receiver, address _folderAddress , string memory folderHash ) public returns(bool)
    { 
        uint256 time = block.timestamp;
 ...
 /**
   ...
   */
    function getFileTransferProofs(string memory fileHash, uint256 Index) public view returns(address[] memory,bytes32,bool)
    {   
  ...
  /**
    ...
    */
    function getFileTransferProofWithTDateTime(string memory fileHash, uint256 Index) public view returns(address[] memory,bytes32, uint256[] memory,bool)
    {
        require(fileExists(fileHash),"No file found");
   ...
   * @return , address of sender , reciever and QR code 
   */
    function getFolderTransferProofs(address folderAddress, uint256 Index) public view returns (address[] memory, string memory,bytes32,bool)
    {   
        require(folderExists(folderAddress),"No folder found");
        (address[] memory senderAndReceiver ,string memory folderHash,bytes32 QR,bool nextIndexPresent) = _inGetFolderTransferProofs(folderAddress, Index); 
   ...
   * @return , address of sender , reciever and QR code with day ,month and year information also
   */
    function getFolderTransferProofsWithDateTime(address folderAddress , uint256 Index) public view returns(address[] memory, string memory,bytes32, uint256[] memory,bool)
    {
        require(folderExists(folderAddress),"No folder found");
        //sending length in this function to remove "STACK TOO DEEEP ERROR" 
        uint256 len = folderProofs[folderAddress].length;
        (address[] memory senderAndReceiver, string memory folderHash,bytes32 QR,uint256[] memory Date,bool nextIndexPresent) = _inGetFolderTransferProofsWithDateTime(folderAddress, Index, len);
   ...
   */
    function SearchFileTransferProof(bytes32 QRCode) public view returns(address , address , string memory)
    {
   ...
   */
    function SearchFileTransferProofWithTime(bytes32 QRCodeTime) public view returns(address , address , uint256 , uint256 , uint256 ,string memory)
    {
   ...
   */
    function SearchFolderTransferProof(bytes32 QRCode) public view returns(address , address , address , string memory)
    {
   ...
   */
    function SearchFolderTransferProofWithTime(bytes32 QRCodeTime) public view returns(address ,address , address, string memory , uint256 , uint256 , uint256)
    {
   ...
   */
    function getQRCodeForFile (address _sender, address _receiver,string memory fileHash, uint256 timestamp) internal pure returns (bytes32)
    {
        bytes32 QRCodeHash;
   ...
   * Can generate QR code with time and without time
   */
    function getQRCodeForFolder (address _sender, address _receiver,address folderAddress,string memory folderHash, uint256 timestamp) internal pure returns (bytes32)
    {
        bytes32 QRCodeHash;
